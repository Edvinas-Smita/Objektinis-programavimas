...
public class TheInputField extends JTextField implements Resizeable {
	...
	TheInputField(TheFrame frame, String label, double partOfWidth, double partOfHeight, double offsetX, double offsetY, HasAction action) {
		this.frame = frame;
